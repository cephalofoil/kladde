        ...
        async (workspaceId: string) => {
            ...
            for (let i = 0; i < workspaceBoards.length; i++) {
                ...
                if (workspaceId === QUICK_BOARDS_WORKSPACE_ID) {
                    ...
                    const index = quickBoards.findIndex(
                        (b) => b.id === board.id,
                    );
                    fileName = `${index + 1}`;
                } else {
        ...
        async (
            ...
            if (type === "disk") {
                ...
                try {
                    ...
                    const hasAccess =
                        await hasWorkspaceStorageDirectory(workspaceId);
                    if (hasAccess) {
                ...
                <CardContent>
                    ...
                    {!fsApiSupported && (
                        <p className="text-xs text-muted-foreground mt-4 p-3 bg-muted/50 rounded-lg">
                            Disk storage requires Chrome or Edge browser with
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            ...
                            <p className="text-xs text-muted-foreground">
                                Automatically save boards to disk when changes
                                are made.
                                <br />
                                Use{" "}
