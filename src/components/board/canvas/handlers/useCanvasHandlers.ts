                ...
                if (hasShapeElements) {
                    ...
                    for (const el of currentElements) {
                        if (el.type === "arrow" || el.type === "line") {
                            ...
                            if (
                                (startConnectedId &&
                                    draggedIdSet.has(startConnectedId)) ||
                                (endConnectedId &&
                                    draggedIdSet.has(endConnectedId))
                            ) {
    ...
    const handleMouseDown = (e: ReactMouseEvent) => {
            ...
            if (textInput && tool === "text") {
                ...
                const clickedInsideEditor =
                    !!editor &&
                    (target === editor ||
                        target?.closest?.("textarea") === editor);
            ...
            if (tool === "select") {
                ...
                if (
                    ...
                    const editLineHeight =
                        selectableClickedElement.lineHeight ?? 1.25;
                    const isTextBox =
                        selectableClickedElement.isTextBox ?? true;
                    setTextInput({
                ...
                if (e.detail === 2 && !isRemotelySelected) {
                    ...
                    if (shapeToEdit) {
                        ...
                        const editFontSize =
                            shapeToEdit.fontSize ??
                            shapeToEdit.strokeWidth * 4 + 12;
                        ...
                        setEditingTextStyle({
                            ...
                            fontFamily:
                                shapeToEdit.fontFamily || "var(--font-inter)",
                            ...
                            lineHeight:
                                shapeToEdit.lineHeight ?? editLineHeight,
                        });
            ...
            if (tool === "tile") {
                ...
                if (tileType === "tile-note") {
                    ...
                    initialTileContent.noteFontFamily = fontFamily;
                    initialTileContent.noteTextAlign = "center";
                }
