    ...
    const renderElementInner = (
        ...
        const effectiveElement: BoardElement = viewerTheme
            ? {
                  ...baseElement,
                  strokeColor:
                      adaptColor(baseElement.strokeColor) ??
                      baseElement.strokeColor,
        ...
        switch (effectiveElement.type) {
            case "pen": {
                ...
                const roughFill =
                    ...
                    !isHighlighter &&
                    (usePatternFill ||
                        (handDrawnMode && elFillPattern !== "solid"))
                        ? renderRoughElement(
                    ...
                    if (
                        ...
                        return (
                            <polygon
                                ...
                                fill={
                                    normalized === "triangle" ? stroke : "none"
                                }
                                stroke={
                                    normalized === "triangle_outline"
                                        ? stroke
                    ...
                    if (
                        ...
                        return (
                            <polygon
                                ...
                                fill={
                                    normalized === "diamond" ? stroke : "none"
                                }
                                stroke={
                                    normalized === "diamond_outline"
                                        ? stroke
            ...
            case "rectangle": {
                ...
                if (handDrawnMode) {
                    const useSolidFill =
                        elFillPattern === "solid" && hasVisibleFill;
                    const roughElement = renderRoughElement(effectiveElement, {
                        opacity,
                        isMarkedForDeletion,
                        transform: `${rotationTransform || ""} translate(${effectiveElement.x}, ${effectiveElement.y})`,
                    ...
                    if (roughElement) {
                        return (
                            <g key={effectiveElement.id}>
                                ...
                                {!hasVisibleFill &&
                                    effectiveElement.strokeWidth > 0 && (
                                        <rect
                                            data-element-id={
                                                effectiveElement.id
                                            }
                                            x={
                                                (effectiveElement.x ?? 0) -
                                                hitboxOffset
                                            }
                                            y={
                                                (effectiveElement.y ?? 0) -
                                                hitboxOffset
                                            }
                                            width={
                                                (effectiveElement.width ?? 0) +
                                                hitboxOffset * 2
                                            }
                                            height={
                                                (effectiveElement.height ?? 0) +
                                                hitboxOffset * 2
                                            }
                                            stroke="transparent"
          ...
          `;
            ...
            case "text": {
                ...
                const hasBeenResized =
                    element.width !== undefined &&
                    element.width < fallbackSize.width;
                        ...
                        >
                            <div
                                ...
                                style={{
                                    ...
                                    whiteSpace: hasBeenResized
                                        ? "pre-wrap"
                                        : "pre",
                                    overflowWrap: hasBeenResized
                                        ? "anywhere"
                                        : "normal",
                                    wordBreak: hasBeenResized
                                        ? "break-word"
                                        : "normal",
                        ...
                        const getConnectedArrowLength = (
                            ...
                            const candidate =
                                ...
                                (connectedArrows.length > 0
                                    ? connectedArrows[0]
                                    : null);
                            if (!candidate || candidate.points.length < 2)
                                return null;
                        ...
                        return filteredEdgeHandles.map((edge) => {
                            ...
                            const handleMouseEnter = () => {
                                ...
                                if (arrowHandleHoverTimerRef.current) {
                                    clearTimeout(
                                        arrowHandleHoverTimerRef.current,
                                    );
                                }
                            ...
                            const handleMouseDown = (e: ReactMouseEvent) => {
                                ...
                                if (
                                    ...
                                    const duplicatedElement: BoardElement = {
                                        ...
                                        fillPattern:
                                            selectedElement.fillPattern,
                                        // For tiles: copy type but not content
                                        ...(selectedElement.type === "tile"
                                            ? {
                                                  tileType:
                                                      selectedElement.tileType,
                                        ...
                                        previewTargetSnapPoint && (
                                            <g opacity={0.5}>
                                                ...
                                                <line
                                                    ...
                                                    y1={snapPoint.y}
                                                    x2={
                                                        previewTargetSnapPoint.x
                                                    }
                                                    y2={
                                                        previewTargetSnapPoint.y
                                                    }
                                                    stroke="var(--accent)"
                                                    strokeWidth={2 / zoom}
                                                    strokeDasharray={`${4 / zoom},${4 / zoom}`}
