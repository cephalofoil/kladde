...
export function CodeRenderer({
  ...
  if (isEditing || !readOnly) {
    return (
      ...
      >
        ...
        <div className="flex items-center justify-between px-2.5 py-1.5 bg-neutral-900/50">
          <span className="text-[10px] text-neutral-400 font-mono uppercase tracking-wider select-none">
        ...
        <textarea
          ...
          onWheel={handleWheel}
          className={cn(
            "flex-1 bg-neutral-800 text-neutral-200 font-mono text-xs",
  ...
  return (
    ...
    >
      {/* Minimalist Header */}
      <div className="flex items-center justify-between px-2.5 py-1.5 bg-neutral-950">
        <span className="text-[10px] text-neutral-400 font-mono uppercase tracking-wider select-none pointer-events-none">
          {LANGUAGES.find((l) => l.value === detectedLanguage)?.label || "Code"}
        </span>
        <button
          onClick={(e) => {
            e.stopPropagation();
          ...
          className="text-neutral-400 hover:text-neutral-200 transition-colors p-1 rounded hover:bg-neutral-700/50"
          title="Copy code"
        >
          {copied ? (
