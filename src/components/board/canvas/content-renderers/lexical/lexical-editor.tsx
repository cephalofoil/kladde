...
const theme = {
  heading: {
    h1: "text-3xl font-bold mb-3 mt-6 first:mt-0 leading-tight",
    h2: "text-2xl font-semibold mb-2 mt-5 first:mt-0 leading-tight",
    h3: "text-xl font-semibold mb-2 mt-4 first:mt-0 leading-tight",
  },
  ...
  quote:
    "border-l-4 border-primary/30 pl-4 py-2 my-3 italic text-muted-foreground bg-muted/20 rounded-r",
