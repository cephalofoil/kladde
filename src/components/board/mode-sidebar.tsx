...
const TILE_TYPES: TileTypeInfo[] = [
  ...
  },
  {
    ...
    label: "Note",
    color:
      "bg-amber-50 hover:bg-amber-100 dark:bg-amber-800/50 dark:hover:bg-amber-700/60",
    hotkey: "N",
  },
  {
    type: "tile-code",
    ...
    label: "Code",
    color:
      "bg-neutral-700 hover:bg-neutral-800 dark:bg-neutral-900 dark:hover:bg-neutral-950 text-white",
    hotkey: "C",
  },
  {
    type: "tile-mermaid",
    ...
    label: "Diagram",
    color:
      "bg-sky-50 hover:bg-sky-100 dark:bg-neutral-800 dark:hover:bg-neutral-700",
    hotkey: "D",
  },
  {
    type: "tile-image",
  ...
  },
  {
    ...
    label: "Doc",
    color:
      "bg-orange-50 hover:bg-orange-100 dark:bg-orange-800/50 dark:hover:bg-orange-700/60",
    hotkey: "O",
  },
];
