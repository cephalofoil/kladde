    ...
    const shortcuts = useMemo(
        () => [
            ...
            },
            {
                ...
                items: [
                    {
                        keys: [shiftKey, altKey, "C"],
                        description: "Copy to clipboard as PNG",
                    },
                    { keys: [modKey, altKey, "C"], description: "Copy styles" },
                    {
                        keys: [modKey, altKey, "V"],
            ...
            },
            {
                category: "View",
                items: [
                    { keys: [altKey, "R"], description: "Toggle view mode" },
                    {
                        keys: [altKey, "S"],
                        description: "Toggle snap to objects",
                    },
                ],
            },
            {
