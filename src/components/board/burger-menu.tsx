            ...
            <DropdownMenuContent align="start" className="w-64 select-none">
                ...
                <div className="px-2 py-1.5 flex items-center justify-between gap-2">
                    ...
                    <button
                        ...
                        aria-label="Toggle hand-drawn mode"
                        title={
                            handDrawnMode
                                ? "Disable hand-drawn mode"
                                : "Enable hand-drawn mode"
                        }
                    >
                        <div
                            className={cn(
                                "w-5 h-5 rounded-full transition-all absolute top-1",
                                handDrawnMode
                                    ? "left-8 bg-primary-foreground"
                                    : "left-1 bg-foreground/60",
                            )}
                        />
                    </button>
                </div>
