...
export function Whiteboard({
    ...
    useEffect(() => {
        ...
        if (!lastChangeIsRemoteRef.current) return;
        undoStackRef.current = [];
        redoStackRef.current = [];
        setCanUndo(false);
        setCanRedo(false);
    }, [collaboration, elements, lastChangeIsRemoteRef]);
    ...
    useEffect(() => {
        ...
        const initializeCollaboration = async () => {
            ...
            if (collabEncryptionKey) {
                ...
                console.log(
                    "[Whiteboard] E2E encryption enabled (from hash URL)",
                );
    ...
    const handleWrapInFrame = useCallback(() => {
        ...
        const frameElement: BoardElement = {
            ...
            label: "Frame",
            zIndex:
                Math.min(...selectedElements.map((el) => el.zIndex ?? 0)) - 1,
        };
    ...
    const handlePasteStyles = useCallback(() => {
        ...
        selectedElements.forEach((el) => {
            ...
            if (
                copiedStyles.cornerRadius !== undefined &&
                el.type === "rectangle"
            ) {
    ...
    const handleFlipHorizontal = useCallback(() => {
        ...
        selectedElements.forEach((element) => {
            ...
            if (
                ...
                const newX =
                    centerX * 2 - (element.x ?? 0) - (element.width ?? 0);
    ...
    const handleFlipVertical = useCallback(() => {
        ...
        selectedElements.forEach((element) => {
            ...
            if (
                ...
                const newY =
                    centerY * 2 - (element.y ?? 0) - (element.height ?? 0);
