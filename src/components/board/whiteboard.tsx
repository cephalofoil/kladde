            ...
            reader.onload = (event) => {
                try {
                    ...
                    if (data.type !== "shadeworks") {
                        alert(
                            "Invalid file format. Please select a .shadeworks file.",
                        );
                        return;
                    }
    ...
    return (
        <div className="relative w-screen h-screen overflow-hidden flex">
            ...
            <div className="relative flex-1 overflow-hidden">
                ...
                {/* Old toolbar - hidden for now, will remove after tile implementation is complete */}
                {false && !isReadOnly && (
                    <Toolbar
                        selectedTool={tool}
                        onToolChange={setTool}
                        ...
                        <div className="bg-card/95 backdrop-blur-md border border-border rounded-xl shadow-2xl p-6 w-96 max-w-[90vw]">
                            ...
                            <div className="mb-4">
                                ...
                                <p className="text-xs text-muted-foreground mt-1">
                                    {saveFileName &&
                                        !saveFileName.endsWith(".shadeworks")}
                                </p>
                            </div>
