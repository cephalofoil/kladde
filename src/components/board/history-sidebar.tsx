...
interface HistorySidebarProps {
  ...
  isPinned: boolean;
  onTogglePin: () => void;
  onPreviewSnapshot?: (entryId: string | null, highlightIds?: string[]) => void;
      ...
      <div className="flex-1 min-w-0">
        ...
        {change.changedProperties && change.changedProperties.length > 0 && (
          <div className="flex flex-wrap gap-1 mt-1">
            {change.changedProperties.slice(0, 4).map((prop) => (
              <span
                key={prop}
  ...
  return (
    <div
      className={cn(
        ...
        isPinned ? "w-80" : "fixed right-0 top-0 bottom-0 w-80 z-[9999]",
      )}
    >
      {/* Header */}
        ...
        {entries.length === 0 ? (
          ...
          <div className="p-2">
            {groupedEntries.map((group) => {
              const isChunkSelected = selectedChunkKey === group.key;
              ...
              return (
                <div key={group.key} className="mb-3">
                  ...
                  >
                    <button
                      onClick={() => toggleChunkCollapsed(group.key)}
                    ...
                    <button
                      onClick={() => handleChunkClick(group)}
                  ...
                  {!isCollapsed && (
                    <div className="ml-2 border-l border-border/40 pl-2 space-y-1 mt-1">
                      {group.entries.map((entry) => {
                        ...
                        const isCurrentEntry = entry.id === latestEntryId;
                        ...
                        return (
                          <div
                            ...
                            onClick={() => handleEntryClick(entry, group.key)}
                          >
                            <div className="p-2">
                              <div className="flex items-start gap-2">
                                ...
                                <div
                                  className={cn(
                                    ...
                                    getOperationBgColor(entry.operation),
                              ...
                              {/* Expanded details */}
                              {!isCompact && isExpanded && hasChanges && (
      ...
      <div className="p-3 border-t border-border/60">
        {selectedEntry ? (
          ...
          >
            ...
            <span className="text-sm font-medium">Restore this version</span>
          </button>
        ) : (
