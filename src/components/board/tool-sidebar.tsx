...
export function ToolSidebar({
            ...
            if (
                ...
                return (
                    <circle
                        ...
                        stroke={
                            normalized === "circle_outline" ? stroke : "none"
                        }
            ...
            if (
                ...
                return (
                    <polygon
                        ...
                        stroke={
                            normalized === "triangle_outline" ? stroke : "none"
                        }
            ...
            if (normalized === "diamond" || normalized === "diamond_outline") {
                ...
                return (
                    <polygon
                        ...
                        stroke={
                            normalized === "diamond_outline" ? stroke : "none"
                        }
    ...
    const hasNoteSelection =
        ...
        selectedElements.some(
            (el) => el.type === "tile" && el.tileType === "tile-note",
        );
    const showAlign =
        hasSelectedElements &&
    ...
    const condensedSidebar = (
        ...
        >
            <div className="bg-card/95 backdrop-blur-md border border-border/60 dark:border-transparent rounded-md shadow-2xl py-2 px-1.5 flex flex-col items-center gap-2 max-h-[calc(100vh-160px)] overflow-y-auto overscroll-contain scrollbar-thin scrollbar-thumb-border scrollbar-track-transparent text-foreground">
                ...
                {hasSelectedElements && !hasNoteSelection && onCopySelected && (
                    <button
                        type="button"
                    ...
                    >
                        <div className="grid grid-cols-2 gap-1">
                            {arrowEndOptions.map((opt) => {
                                ...
                                const isSelected =
                                    currentValue === normalizeArrowhead(opt.id);
                                return (
                                    <button
